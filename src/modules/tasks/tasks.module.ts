...
@Module({
    imports: [
        ...
        TypeOrmModule.forFeature([SesionConversacion, PlantillaMensaje, Lead, HistorialPlantillas, Mensaje, HistorialChatAi, Cita]),
        WebhookModule,
        InboxModule,
    ],
    providers: [RecoveryTasksService, RecordatorioCitasService],
})
